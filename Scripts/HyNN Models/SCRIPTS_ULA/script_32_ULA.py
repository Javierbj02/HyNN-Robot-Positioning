...
# ! Load the dataset from the corresponding CSV file
...
# !! Define the folder where models, results, images... will be saved
...
if not os.path.exists(images_folder):
    ...
    # ! Save the tinto model for image generation
...
# VALIDATION RESULTS
# ! Save the results in your corresponding folder
...
results_filename = images_folder+results_folder+'ULA_32.txt'
